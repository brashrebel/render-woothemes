...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            ...
            src: {
                files: {
                    'src/assets/js/render-edd.min.js': ['src/assets/js/source/**/*.js', '!src/assets/js/source/admin/**/*.js']
                }
            },
            admin: {
                files: {
                    'src/assets/js/render-edd-admin.min.js': ['src/assets/js/source/admin/*.js']
                }
            }
        },
        ...
        sass: {
            ...
            src: {
                files: {
                    'src/assets/css/render-edd.min.css': 'src/assets/scss/main.scss'
                }
            },
            admin: {
                files: {
                    'src/assets/css/render-edd-admin.min.css': 'src/assets/scss/admin/admin.scss'
                }
            }
        },
        ...
        'string-replace': {
            version: {
                ...
                options: {
                    replacements: [{
                        ...
                        pattern: /(define.*?RENDER_WOOTHEMES_VERSION.*?)\d\.\d\.\d/,
                        replacement: "$1" + pkg.version
                    }]
                }
            },
            header: {
                files: {
                    'build/render-edd.php': ['build/render-woothemes.php', '!' + image_ignore]
                },
                options: {
                    replacements: [{
                        pattern: /\/\/\{\{HEADER}}/,
                        replacement: '/*\n' +
                        ' * Plugin Name: ' + pkg.name.replace(/_/g, ' ') + '\n' +
